                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-8">
                    ...
                    <div className="md:col-span-5">
                        ...
                        <p className="text-gray-400 text-sm leading-relaxed max-w-md">
                            La herramienta que te permite mostrar todos tus
                            links en un solo lugar. Crea tu landing multi
                            enlaces gratis ahora. Linkea es una herramienta
                            gratuita que te permite crear paginas de destino con
                            multiples enlaces. Simplemente, crea tu pagina, y
                            agrega todos tus enlaces en un solo lugar.
                        </p>
                    </div>
                ...
                <div className="border-t border-gray-700 pt-6">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        ...
                        <p className="text-gray-500 text-sm">
                            Copyright © {currentYear} Todo los derechos
                            reservados{" "}
                            <Link
                                href="/"
