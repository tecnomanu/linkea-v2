...
export default function Landings({ auth, landings, filters }: LandingsProps) {
    ...
    const columns = [
        {
            ...
            render: (landing: Landing) => (
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <p className="font-medium">{landing.name || "Sin nombre"}</p>
    ...
    const renderActions = (landing: Landing) => (
        <div className="relative">
            <button
                onClick={() =>
                    setOpenDropdown(openDropdown === landing.id ? null : landing.id)
                }
