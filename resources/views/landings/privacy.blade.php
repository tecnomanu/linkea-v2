...
<head>
    <!-- Page Information -->
    <meta charset="utf-8">
    <title>{{env("APP_NAME", "Landing")}} - Politicas de pricidad</title>
    <meta name="description" content="Linkea - Politicas de Privacidad.">
    <meta name="author" content="Linkea.ar">
    <link rel="canonical" href="https://linkea.ar/privacy">
    <!-- CSS -->
...
<body>
    <div class="container container-justify">
        ...
        <p> El sitio web www.linkea.ar es propiedad de Linkea, que es un controlador de datos de tus datos personales. </p>
        <p> Hemos adoptado esta Política de privacidad, que determina cómo procesamos la información recopilada por
            www.linkea.ar, que también proporciona las razones por las que debemos recopilar ciertos datos personales sobre
            ti. Por lo tanto, debes leer esta Política de privacidad antes de usar el sitio web de www.linkea.ar. </p>
        ...
        <p> Cuando visitas www.linkea.ar, recopilamos automáticamente cierta información sobre tu dispositivo, incluida
            ...
            información de pago, etc.) durante el registro para poder cumplir con el acuerdo. </p>
        <h4> ¿Por qué procesamos tus datos? </h4>
        <p> Nuestra máxima prioridad es la seguridad de los datos del cliente y, como tal, podemos procesar solo los datos
            ...
            identifique a ningún usuario en particular del sistema. </p>
        <p> Puedes visitar la web sin decirnos quién eres ni revelar ninguna información por la cual alguien pueda
            identificarte como una persona específica. Sin embargo, si deseas utilizar algunas de las funciones del sitio
            web, o deseas recibir nuestro boletín informativo o proporcionar otros detalles al completar un formulario,
            ...
            contactarnos directamente desde el sitio web. Los usuarios que no estén seguros de qué información es
            obligatoria pueden ponerse en contacto con nosotros a través de hola@linkea.ar. </p>
        <h4> Tus derechos: </h4>
        ...
        <p> Además, si eres residente europeo, destacamos que estamos procesando tu información para cumplir con los
            contratos que podríamos tener contigo (por ejemplo, si realizas un pedido a través de la web), o de otra manera
            para seguir nuestros intereses comerciales legítimos enumerados anteriormente. Además, ten en cuenta que tu
            información puede transferirse fuera de Europa, incluidos Canadá y Estados Unidos. </p>
        <h4> Enlaces a otros sitios web: </h4>
        <p> Nuestra web puede contener enlaces a otros sitios web que no son de nuestra propiedad ni están controlados por
            ...
            privacidad de cada web que pueda recopilar información personal. </p>
        <h4> Seguridad de la información: </h4>
        <p> Aseguramos la información que proporcionas en servidores informáticos en un entorno controlado y seguro,
            ...
            divulgación de datos personales bajo su control y custodia. Sin embargo, no se puede garantizar la transmisión
            de datos a través de Internet o redes inalámbricas. </p>
        <h4> Divulgación legal: </h4>
        <p> Divulgaremos cualquier información que recopilemos, usemos o recibamos si así lo requiere o lo permite la ley,
            como para cumplir con una citación o un proceso legal similar, y cuando creemos de buena fe que la divulgación
            es necesaria para proteger nuestros derechos, proteger tu seguridad o la seguridad de los demás, investigar el
            fraude o responder a una solicitud del gobierno. </p>
        ...
        <p> Si deseas comunicarte con nosotros para comprender más sobre esta Política o deseas comunicarte con nosotros en
            ...
            correo electrónico a hola@linkea.ar. </p>

        <x-landing.footer class="text-center"></x-landing.footer>
    </div>
</body>